...
HEADERS = {
    # Be polite & avoid being blocked by Wikipedia
...
def extract_headings_markdown(html: str, page_title: str):
    ...
    # If first H1 is the title, skip it; we'll add our own
...
def outline(country: str = Query(..., description="Country name (e.g., Vanuatu)")):
    try:
        ...
        raise HTTPException(status_code=504, detail="Upstream timeout from Wikipedia.")
    except Exception as e:
        # Log the error message for Vercel logs
